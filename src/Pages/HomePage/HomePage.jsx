    ...
    <>
        <div className={`absolute inset-0 bg-center bg-cover origin-center animate-bg bg-[url('./assets/hero.avif')]
          ...
          <div className="container mx-auto transition-all h-full duration-300 ease-in-out">
            ...
            <h1 className={`text-white dark:text-gray-900 font-bold text-3xl sm:text-5xl font-serif leading-[1.2] animate__animated animate__fadeInDownBig`}>Hi, I am <span className='text-blue-500 whitespace-nowrap '>Mohamed Elshora</span></h1>
            <p className={`text-white dark:text-gray-900 text-xl sm:text-2xl my-5 animate__animated animate__fadeInLeftBig animate__delay-1s`}>I am a frontend web developer. I can provide clean code and pixel perfect design. I also make website more & more interactive with web animations.</p>
          
            <div className='flex items-center gap-5 animate__animated animate__fadeInUpBig animate__delay-2s'>
