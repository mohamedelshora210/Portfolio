...
export default function HeaderSection({title}) {
  ...
  <h2 className="relative text-4xl sm:text-5xl font-bold text-white dark:text-gray-900 z-10 uppercase
  ...
  <div className="absolute top-[52%] left-0 w-full h-20 overflow-hidden z-0">
    <h3
      className="text-5xl sm:text-8xl font-bold text-white dark:text-gray-900 opacity-20 uppercase"
      style={{
